...
import team2 from '../assets/Bahlem.jpg';
    ...
    <div className="container" data-scrollax-parent="true">
      <div className="row slider-text align-items-end">
        <div className="col-md-7 col-sm-12 ftco-animate mb-5">
          <p className="breadcrumbs" data-scrollax=" properties: { translateY: '70%', opacity: 1.6}"><span className="mr-2"><a href="">Home</a></span></p>
          <h1 className="mb-3 navbar-brand" data-scrollax=" properties: { translateY: '70%', opacity: .9}">Sign Up In <span style={{color : 'blue', fontWeight : 'bold' }}>Doctor</span><span style={{ fontWeight : 'bold'  }}> Nexus</span></h1>
  ...
  <div className="container">
    <div className="row justify-content-center mb-5 pb-5">
      <div className="col-md-7 text-center heading-section ftco-animate">
        <h2 className="mb-3">Doctor Nexus Team</h2>
      </div>
      ...
      <div className="col-md-4 col-lg-4 ">
        <div className="card bg-light">
          <div className="card-body text-center">
            ...
            <h3 className="card-title mb-3">Kunal Bobde</h3>
            <p className="card-text">
              WEB DEVElOPER
            </p>
            <br />
            <a href=""><i className="fa fa-google text-dark mx-1" /></a>
            <a href=""><i className="fa fa-github text-dark mx-1" /></a>
            <a href=""><i className="fa fa-linkedin text-dark mx-1" /></a>
            <a href=""><i className="fa fa-instagram text-dark mx-1" /></a>
          </div>
        </div>
      </div>
      <div className="col-md-4 col-lg-4">
        <div className="card bg-light">
        <div className="card-body text-center">
            <img src={team2} style={{width :"300px", height:"250px"}} className=" mb-3" alt />
            <h3 className="card-title mb-3">Kunal Verma</h3>
            <p className="card-text">
