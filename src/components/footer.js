  ...
  <div className="row mb-5">
    <div className="col-md-3">
      <div className="ftco-footer-widget mb-4">
        <h2 className="ftco-heading-2">Doctor Nexus.</h2>
      ...
      <div className="ftco-footer-widget mb-4">
        ...
        <div className="block-23 mb-3">
          <ul>
            ...
            <li><a href="ok"><span className="icon icon-envelope" /><span className="text"> DoctorNexus.reply@gmail.com</span></a></li>
          </ul>
        </div>
      </div>
    </div>
  ...
  <div className="row">
    <div className="col-md-12 text-center">
      <p>{/* Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. */}
        Copyright © All rights reserved | This website is developed with <i className="icon-heart" aria-hidden="true" /> by <a href="#" target="_blank">Team-Nexus</a>
